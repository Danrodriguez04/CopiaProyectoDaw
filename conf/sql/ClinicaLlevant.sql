...
create table pacientes (
    ...
    compañia_Aseguradora boolean default 0,
    id_historial int,
    id_usuario int,
...
/*se refiere a si es general, oftamologia....*/
...
/*El formato es si es presencial, telefonica o presencial*/
...
create table citas (
    ...
    constraint fk_cita_formato_cita foreign key(id_formato_cita) references formato_cita(id)
);
...
/*El estado de la factura es si esta pagado o no*/
...
create table facturas(
    ...
    constraint fk_factura_estado_factura foreign key (id_estado_factura) references estado_factura(id)
...
create table diagnostico (
    ...
    constraint fk_diagnostico_paciente foreign key(id_paciente) references pacientes(id)
);
